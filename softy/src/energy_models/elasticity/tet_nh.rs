...
pub struct TetMeshNeoHookean<'a>(&'a TetMeshSolid);
...
impl EnergyHessian for TetMeshNeoHookean<'_> {
    fn energy_hessian_size(&self) -> usize {
        Self::NUM_HESSIAN_TRIPLETS_PER_TET * self.tetmesh.num_cells()
    }
...

        {
            ...
            let hess_iter = hess_chunks
                ...
                .zip(zip!(
                    ...
                    tetmesh
                        .attrib_as_slice::<LambdaType, CellIndex>(
                            LAMBDA_ATTRIB,
                        )
                        .unwrap()
                        .par_iter(),
                    tetmesh
                        .attrib_as_slice::<MuType, CellIndex>(
                            MU_ATTRIB,
                        )
                        .unwrap()
                        .par_iter(),
