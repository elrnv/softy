...
pub const POSITION64_ATTRIB: &str = "p64";
...
pub(crate) const NET_FORCE_ATTRIB: &str = "net_force";
...
pub(crate) const REL_MESH_SIZE_ATTRIB: &str = "__softy_rel_mesh_size";
...
pub(crate) type RelMeshSizeType = f64;
pub(crate) type StiffnessType = f32;
