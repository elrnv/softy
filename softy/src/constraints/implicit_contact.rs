...
impl ContactConstraint for ImplicitContactConstraint {
    ...
    fn update_cache(
        &mut self,
        sim_pos: SubsetView<Chunked3<&[f64]>>,
        ...
        self.update_contact_points(sim_pos);
...
impl<'a> ConstraintJacobian<'a, f64> for ImplicitContactConstraint {
    #[inline]
