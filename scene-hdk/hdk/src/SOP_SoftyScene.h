...
class SOP_SoftyScene : public SOP_Node
{
public:
    static PRM_Template *buildTemplates();
    static OP_Node *myConstructor(OP_Network* net, const char * name, OP_Operator * op)
    {
        return new SOP_SoftyScene(net, name, op);
    }
...
protected:
    SOP_SoftyScene(OP_Network *net, const char *name, OP_Operator *op)
